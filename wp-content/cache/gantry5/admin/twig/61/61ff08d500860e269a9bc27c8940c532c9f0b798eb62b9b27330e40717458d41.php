...
class __TwigTemplate_cd8766cc12df85a2a27cf1c1302124af72d3831f3e056cc418c331c9ab77f7bc extends Twig_Template
{
...
";
    ...
    public function block_javascript($context, array $blocks = array())
    {
        ...
        echo "';
            var GANTRY_AJAX_URL = '";
        // line 9
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", array(0 => "%ajax%"), "method"), "html", null, true);
        echo "';
            var GANTRY_AJAX_CONF_URL = '";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "route", array(0 => "configurations/%ajax%"), "method"), "html", null, true);
        echo "';
...
/*             var GANTRY_AJAX_URL = '{{ gantry.route('%ajax%') }}';*/
/*             var GANTRY_AJAX_CONF_URL = '{{ gantry.route('configurations/%ajax%') }}';*/
