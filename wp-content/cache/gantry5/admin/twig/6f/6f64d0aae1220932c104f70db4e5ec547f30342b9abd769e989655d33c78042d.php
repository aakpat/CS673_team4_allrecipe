...
class __TwigTemplate_b032a324291c45ffd6ca246116923965263e35adffb081f2e82db6549c7dc59c extends Twig_Template
{
...
/*                 <button class="button" type="button" aria-label="{{ 'GANTRY5_PLATFORM_SELECT'|trans }} {{ field.label }}" data-g5-filepicker="{{ picker|json_encode()|e('html_attr') }}">*/
/*                     <i class="fa {{ field.icon|default('fa-file-o') }}" ></i>*/
/*                 </button>*/
/*             </span>*/
