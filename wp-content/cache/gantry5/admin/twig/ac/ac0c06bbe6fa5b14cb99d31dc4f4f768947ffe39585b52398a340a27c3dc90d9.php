...
class __TwigTemplate_36f6e81f0e66359f0dcfa43a88f80a6e94a1a705eabb65285dd563ce51c53757 extends Twig_Template
{
...
/*                 <button class="button" type="button" aria-label="{{ 'GANTRY5_PLATFORM_SELECT'|trans }} {{ field.label }}" data-g5-iconpicker="{{ picker|e('html_attr') }}">*/
