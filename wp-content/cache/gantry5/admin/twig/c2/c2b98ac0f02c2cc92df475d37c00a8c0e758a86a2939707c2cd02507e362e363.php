...
class __TwigTemplate_acc4e22bd12e8cc04d117c8bb1bab8403ea1855f4ca4eaa85a3f2a867167b84c extends Twig_Template
{
...
(isset($context["gantry"]) ? $context["gantry"] : null), "title" => $this->env->getExtension('GantryTwig')->transFilter("GANTRY5_PLATFORM_BLOCK"), "blueprints" => $this->getAttribute(            // line 56
...
(isset($context["item"]) ? $context["item"] : null), "inherit", array()), "include", array())) && twig_in_filter($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "inherit", array()), "outline", array()), $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["inheritance"]) ? $context["inheritance"] : null), "form", array()), "fields", array()), "outline", array()), "filter", array())))) ? ($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "inherit", array()), "outline", array())) : (null))));
        ...
        if ((isset($context["inheritance"]) ? $context["inheritance"] : null)) {
            ...
            // line 72
            echo twig_escape_filter($this->env, $this->env->getExtension('GantryTwig')->fieldNameFilter("inherit.section"), "html", null, true);
            echo "\" value=\"";
...
/*             <li>*/
/*                 <a href="#" id="g-settings-block-tab" role="presentation" aria-controls="g-settings-block" role="tab" aria-expanded="false">*/
/*                     {% if inheritable %}<i class="fa fa-fw fa-{{ (item.inherit and ('block' in item.inherit.include)) ? 'lock' : 'unlock' }}"></i>{% endif %}*/
